...
void VComputeNode::traceInitThis__1(VComputeNode__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->declBus(c+28,"io_Out_0_bits_data",-1,31,0);
	...
	vcdp->declBus(c+33,"io_LeftIO_bits_data",-1,31,0);
	...
	vcdp->declBus(c+38,"io_RightIO_bits_data",-1,31,0);
	...
	vcdp->declBus(c+28,"ComputeNode io_Out_0_bits_data",-1,31,0);
	...
	vcdp->declBus(c+33,"ComputeNode io_LeftIO_bits_data",-1,31,0);
	...
	vcdp->declBus(c+38,"ComputeNode io_RightIO_bits_data",-1,31,0);
	vcdp->declBus(c+2,"ComputeNode FU_io_in1",-1,31,0);
	vcdp->declBus(c+3,"ComputeNode FU_io_in2",-1,31,0);
	vcdp->declBus(c+1,"ComputeNode FU_io_out",-1,31,0);
	...
	vcdp->declBus(c+2,"ComputeNode left_R_data",-1,31,0);
	...
	vcdp->declBus(c+3,"ComputeNode right_R_data",-1,31,0);
	...
	vcdp->declBus(c+16,"ComputeNode out_data_R_data",-1,31,0);
	...
	vcdp->declBus(c+2,"ComputeNode FU io_in1",-1,31,0);
	vcdp->declBus(c+3,"ComputeNode FU io_in2",-1,31,0);
	vcdp->declBus(c+1,"ComputeNode FU io_out",-1,31,0);
...
void VComputeNode::traceFullThis__1(VComputeNode__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->fullBus(c+1,(vlTOPp->ComputeNode__DOT__FU_io_out),32);
	vcdp->fullBus(c+2,(vlTOPp->ComputeNode__DOT__left_R_data),32);
	vcdp->fullBus(c+3,(vlTOPp->ComputeNode__DOT__right_R_data),32);
	...
	vcdp->fullBus(c+16,(vlTOPp->ComputeNode__DOT__out_data_R_data),32);
	...
	vcdp->fullBus(c+28,(vlTOPp->io_Out_0_bits_data),32);
	...
	vcdp->fullBus(c+33,(vlTOPp->io_LeftIO_bits_data),32);
	...
	vcdp->fullBus(c+38,(vlTOPp->io_RightIO_bits_data),32);
    }
}
