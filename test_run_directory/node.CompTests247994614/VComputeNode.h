...
VL_MODULE(VComputeNode) {
  public:
    ...
    VL_OUT16(io_Out_0_bits_data,15,0);
    VL_IN16(io_LeftIO_bits_taskID,9,0);
    VL_IN16(io_LeftIO_bits_data,15,0);
    VL_IN16(io_RightIO_bits_taskID,9,0);
    VL_IN16(io_RightIO_bits_data,15,0);
    ...
    VL_SIG16(ComputeNode__DOT__FU_io_out,15,0);
    ...
    VL_SIG16(ComputeNode__DOT__left_R_data,15,0);
    VL_SIG16(ComputeNode__DOT__right_R_taskID,9,0);
    VL_SIG16(ComputeNode__DOT__right_R_data,15,0);
    VL_SIG16(ComputeNode__DOT__out_data_R_data,15,0);
