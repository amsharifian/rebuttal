...
VL_INLINE_OPT void VComputeNode::_sequent__TOP__1(VComputeNode__Syms* __restrict vlSymsp) {
	...
	if (VL_UNLIKELY((((IData)(vlTOPp->ComputeNode__DOT__state) 
			 ...
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FWRITEF(0x80000002U,"[LOG] [ComputeNode] [TID->%4#] [COMPUTE] $anonfun: Output fired @ %5#, Value: %5# (%5# + %5#)\n",
		       ...
		       16,vlTOPp->ComputeNode__DOT__FU_io_out,
		       16,(IData)(vlTOPp->ComputeNode__DOT__left_R_data),
		       16,vlTOPp->ComputeNode__DOT__right_R_data);
	}
    }
    // ALWAYS at ComputeNode.v:272
    if (vlTOPp->reset) {
	...
	if (vlTOPp->ComputeNode__DOT___T_121) {
		...
		vlTOPp->ComputeNode__DOT__out_data_R_data 
		    = ((IData)(vlTOPp->ComputeNode__DOT__enable_R_control)
		        ? (IData)(vlTOPp->ComputeNode__DOT__FU_io_out)
		        : 0U);
	    }
	}
    }
    ...
    vlTOPp->ComputeNode__DOT__FU_io_out = (0xffffU 
					   & ((IData)(vlTOPp->ComputeNode__DOT__left_R_data) 
					      + (IData)(vlTOPp->ComputeNode__DOT__right_R_data)));
...
void VComputeNode::_ctor_var_reset() {
    ...
    io_Out_0_bits_data = VL_RAND_RESET_I(16);
    ...
    io_LeftIO_bits_data = VL_RAND_RESET_I(16);
    ...
    io_RightIO_bits_data = VL_RAND_RESET_I(16);
    ComputeNode__DOT__FU_io_out = VL_RAND_RESET_I(16);
