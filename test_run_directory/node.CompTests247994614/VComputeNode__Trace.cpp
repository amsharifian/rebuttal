...
void VComputeNode::traceChgThis__2(VComputeNode__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus(c+1,(vlTOPp->ComputeNode__DOT__FU_io_out),16);
    }
}
...
void VComputeNode::traceChgThis__3(VComputeNode__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus(c+2,(vlTOPp->ComputeNode__DOT__left_R_data),16);
	vcdp->chgBus(c+3,(vlTOPp->ComputeNode__DOT__right_R_data),16);
	...
	vcdp->chgBus(c+16,(vlTOPp->ComputeNode__DOT__out_data_R_data),16);
...
void VComputeNode::traceChgThis__4(VComputeNode__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBus(c+28,(vlTOPp->io_Out_0_bits_data),16);
	...
	vcdp->chgBus(c+33,(vlTOPp->io_LeftIO_bits_data),16);
	...
	vcdp->chgBus(c+38,(vlTOPp->io_RightIO_bits_data),16);
    }
}
